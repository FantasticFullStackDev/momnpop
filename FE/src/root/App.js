      ...
      <DealContext.Provider value={{ dealData, setDealData }}>
        <main className={`min-vh-100 ${mainClass}`}>
          ...
          <Switch>
            ...
            <UnAuthenticatedRoute exact path="/free-business-invitation" render={(props) => <Business {...props} setWhere={setNewWhere} where={where} />}/>
            ...
            />
            <Route exact path="/about-us" render={(props) => <About {...props} setWhere={setNewWhere}  where={where} />} />
